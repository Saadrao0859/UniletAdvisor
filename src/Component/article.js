...
const articleData = [
  {
    ...
    articledetail:
      "Lorem Ipsum is simply text of the printing and type setting  industry.pecimen variations of assages of Lorem Ipsum available",
  ...
  },
  {
    ...
    articledetail:
      "A standalone house not connected to any other property Offers the most privacy.",
    articleDescription: `Here’s a picture of a modern house. Below is a detailed description in an article format:
